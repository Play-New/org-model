...
export function buildSystemPrompt(ctx: PromptContext): string {
  ...
  const lines = [
    ...
    '',
    'METHOD — you lead, documents first, ask only in the gaps, go wide before deep',
    '1. Contracts: map ALL of them, both legs. Every outward-facing surface (site, statute, deck, a client contract) reveals one; the financials reveal what comes back. Miss a surface, miss a contract.',
    '2. Nodes: take the org chart and remap it onto the contracts; classify each core / service / platform.',
